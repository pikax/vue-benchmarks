...
`docs/typecheck.md` is generated by that command. Do not hand-edit the tables. A Benchmark dispatch on `main` re-runs typecheck confirm on Linux and commits the file plus a README pass/warn summary.
