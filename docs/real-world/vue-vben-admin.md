...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| vben-admin-monorepo — project's own toolchain (baseline) | **10.77 s** | 10.77 s | n/a | n/a | 1.00x | 308 | 31 files/s | 697.8 MB |
| vben-admin-monorepo — unplugin-vue | **11.12 s** | 11.12 s | n/a | n/a | 1.03x | 308 | 30 files/s | 708.7 MB |
| vben-admin-monorepo — @verter/unplugin | **11.22 s** | 11.22 s | n/a | n/a | 1.04x | 308 | 29 files/s | 657.8 MB |
| vben-admin-monorepo — @vizejs/vite-plugin | **41.94 s** | 41.94 s | n/a | n/a | 3.90x | 308 | 8 files/s | 6581.0 MB |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| vue-tsc (JS) | **21.14 s** | 21.03 s | 154.9 ms | 0.7% | 1.00x | 0 | 6 files/s | 1672.6 MB |
...
| Tool | **Median (primary)** | Min | Stddev | CV% | vs fastest | diagnostics | Throughput | Peak RSS |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| vue-tsc (N) | **10.26 s** | 10.25 s | 18.6 ms | 0.2% | 1.00x | 0 | 12 files/s | 2696.7 MB |
| verter-tsc ⚠ | (3.75 s) | (3.69 s) | – | – | not ranked | (156) | – | (728.4 MB) |
| Vize ⚠ | (66.80 s) | (66.76 s) | – | – | not ranked | (21) | – | (3022.8 MB) |
