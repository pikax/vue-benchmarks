...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| element-plus — project's own toolchain (baseline) | **160.55 s** | 160.55 s | n/a | n/a | 1.00x | 2,533 | 1 files/s | 1629.9 MB |
| element-plus — unplugin-vue | **162.66 s** | 162.66 s | n/a | n/a | 1.01x | 2,533 | 1 files/s | 1785.9 MB |
| element-plus — @vizejs/vite-plugin ⚠ | (225.08 s) | (225.08 s) | – | – | not ranked | (2,047) | – | (5421.2 MB) |
| element-plus — @verter/unplugin ⚠ | (110.73 s) | (110.73 s) | – | – | not ranked | (527) | – | (1365.2 MB) |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| vue-tsc (JS) | **29.62 s** | 29.58 s | 57.0 ms | 0.2% | 1.00x | 82 | 26 files/s | 1916.7 MB |
...
| Tool | **Median (primary)** | Min | Stddev | CV% | vs fastest | diagnostics | Throughput | Peak RSS |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| verter-tsc | **4.79 s** | 4.74 s | 73.0 ms | 1.5% | 1.00x | 1,645 | 163 files/s | 649.7 MB |
| vue-tsc (N) | **13.34 s** | 13.17 s | 239.0 ms | 1.8% | 2.79x | 85 | 58 files/s | 2552.4 MB |
| Vize | **61.13 s** | 60.69 s | 633.6 ms | 1.0% | 12.77x | 533 | 13 files/s | 5188.7 MB |
